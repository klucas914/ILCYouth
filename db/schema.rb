...
ActiveRecord::Schema.define(version: 20170421020854) do
  ...
  create_table "check_ins", force: :cascade do |t|
    ...
    t.index ["event_id"], name: "index_check_ins_on_event_id", using: :btree
  ...
  create_table "events_students", force: :cascade do |t|
    t.integer "student_id", null: false
    t.integer "event_id",   null: false
    t.index ["event_id"], name: "index_events_students_on_event_id", using: :btree
    t.index ["student_id"], name: "index_events_students_on_student_id", using: :btree
  end
